...
#define SET_BIT_BANDING(REG,BITNUM)		  (* ( (volatile u32*)( BASE_PER_ALIAS_ADDRESS + ((REG-BASE_PER_ADDRESS)*0x000000020) +(BITNUM*0x00000004)	) )) = 1
#define CLR_BIT_BANDING(REG,BITNUM)		  (* ( (volatile u32*)( BASE_PER_ALIAS_ADDRESS + ((REG-BASE_PER_ADDRESS)*0x000000020) +(BITNUM*0x00000004)	) )) = 0
