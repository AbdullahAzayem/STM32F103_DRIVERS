...
{		
	...
	/*ADC prescaler*/
	SET_BIT_BANDING( (RCC_BASE_ADDRESS+RCC_CFGR_OFFSET), 14 , (  RCC_ADC_PRESCALER    %10) );
	SET_BIT_BANDING( (RCC_BASE_ADDRESS+RCC_CFGR_OFFSET), 15 , ( (RCC_ADC_PRESCALER/10)%10) );
	
	/*APB2 prescaler*/
	SET_BIT_BANDING( (RCC_BASE_ADDRESS+RCC_CFGR_OFFSET), 11 , (  RCC_APB2_PRESCALER     %10) );
	SET_BIT_BANDING( (RCC_BASE_ADDRESS+RCC_CFGR_OFFSET), 12 , ( (RCC_APB2_PRESCALER/10 )%10) );
	SET_BIT_BANDING( (RCC_BASE_ADDRESS+RCC_CFGR_OFFSET), 13 , ( (RCC_APB2_PRESCALER/100)%10) );
	

	/*APB1 prescaler*/
	SET_BIT_BANDING( (RCC_BASE_ADDRESS+RCC_CFGR_OFFSET), 8  , (  RCC_APB1_PRESCALER     %10) );
	SET_BIT_BANDING( (RCC_BASE_ADDRESS+RCC_CFGR_OFFSET), 9  , ( (RCC_APB1_PRESCALER/10 )%10) );
	SET_BIT_BANDING( (RCC_BASE_ADDRESS+RCC_CFGR_OFFSET), 10 , ( (RCC_APB1_PRESCALER/100)%10) );
	
	/*AHB prescaler*/
	SET_BIT_BANDING( (RCC_BASE_ADDRESS+RCC_CFGR_OFFSET), 4  , (  RCC_APB1_PRESCALER      %10) );
	SET_BIT_BANDING( (RCC_BASE_ADDRESS+RCC_CFGR_OFFSET), 5  , ( (RCC_APB1_PRESCALER/10  )%10) );
	SET_BIT_BANDING( (RCC_BASE_ADDRESS+RCC_CFGR_OFFSET), 6  , ( (RCC_APB1_PRESCALER/100 )%10) );
	SET_BIT_BANDING( (RCC_BASE_ADDRESS+RCC_CFGR_OFFSET), 7  , ( (RCC_APB1_PRESCALER/1000)%10) );			
}
